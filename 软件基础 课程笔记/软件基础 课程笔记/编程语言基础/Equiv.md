...
对于包含变量的 **aexp** 和 **bexp** 而言，我们所需的定义简单明了。<u>​ 只要在所有状态下，两个 ​</u>​<u>**aexp**</u>​<u>​ 或 ​</u>​<u>**bexp**</u>​<u>​ 的求值结果相同</u>， 我们就说他们的==*'行为等价（behaviorally equivalent）'*==。
...
以下形式化的定义描述了如何在算术表达式 **a** 中， 将某个变量 **x** 的所有引用都替换成另一个表达式 **u** ：
